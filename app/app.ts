...
import { OpponentPlayer } from './pages/services/opponent-player';
...
@App({
    ...
    providers: [OwnPlayer, OpponentPlayer, NetworkingService, BluetoothClient, BluetoothServer, BluetoothConfig, CharacterGenerator],
})
export class MyApp {
